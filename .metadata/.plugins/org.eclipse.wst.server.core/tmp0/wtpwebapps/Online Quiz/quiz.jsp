...
<style>
    ...
    * {
    ...
    h2 {
        text-align: center;
        font-size: 1.8rem;
        color: #1877f2; /* A nice primary color */
        margin-bottom: 30px;
        font-weight: 600;
    }
    ...
    /* OPTION STYLING (THE FIX FOR ALIGNMENT) */
    .option {
        display: flex;
    ...
    .option:hover {
        background-color: #eaf1fb; /* Subtle hover effect */
    }

    .option input[type="radio"] {
        /* Use default browser styling, but ensure size and color */
        accent-color: #1877f2;
        transform: scale(1.1);
        margin-right: 15px;
        width: 18px;
